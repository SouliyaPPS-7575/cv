...
import { eventHandler as eventHandler$1, toWebRequest as toWebRequest$1, getResponseStatus, getEvent } from '@tanstack/start-server-core';
import { startSerializer } from '@tanstack/start-client-core';
import { jsx, jsxs } from 'react/jsx-runtime';
import { QueryClient, QueryClientProvider } from '@tanstack/react-query';
import { createMemoryHistory, warning, RouterProvider, isPlainObject as isPlainObject$1, pick, TSR_DEFERRED_PROMISE, createControlledPromise, isPlainArray, defer as defer$1, createRootRouteWithContext, Outlet, HeadContent, Scripts, createFileRoute, lazyRouteComponent, Link, useRouter, useMatch, rootRouteId, ErrorComponent, createRouter as createRouter$2, invariant as invariant$1 } from '@tanstack/react-router';
import { routerWithQueryClient } from '@tanstack/react-router-with-query';
import { ReactQueryDevtools } from '@tanstack/react-query-devtools';
import { TanStackRouterDevtools } from '@tanstack/react-router-devtools';
import { createContext as createContext$1, useState, useEffect } from 'react';
import y from 'jsesc';
...
const appConfig$1 = {"name":"vinxi","routers":[{"name":"public","type":"static","dir":"./public","base":"/","root":"/Users/souliya/Documents/FullStackDev/Test/cv","order":0,"outDir":"/Users/souliya/Documents/FullStackDev/Test/cv/.vinxi/build/public"},{"name":"client","type":"client","target":"browser","handler":"src/client.tsx","base":"/_build","build":{"sourcemap":true},"root":"/Users/souliya/Documents/FullStackDev/Test/cv","outDir":"/Users/souliya/Documents/FullStackDev/Test/cv/.vinxi/build/client","order":1},{"name":"ssr","type":"http","target":"server","handler":"src/ssr.tsx","link":{"client":"client"},"root":"/Users/souliya/Documents/FullStackDev/Test/cv","base":"/","outDir":"/Users/souliya/Documents/FullStackDev/Test/cv/.vinxi/build/ssr","order":2},{"name":"server","type":"http","target":"server","base":"/_server","handler":"node_modules/@tanstack/start-server-functions-handler/dist/esm/index.js","root":"/Users/souliya/Documents/FullStackDev/Test/cv","outDir":"/Users/souliya/Documents/FullStackDev/Test/cv/.vinxi/build/server","order":3},{"name":"api","base":"/api","type":"http","handler":"src/api.ts","target":"server","root":"/Users/souliya/Documents/FullStackDev/Test/cv","outDir":"/Users/souliya/Documents/FullStackDev/Test/cv/.vinxi/build/api","order":4}],"server":{"preset":"netlify","experimental":{"asyncContext":true}},"root":"/Users/souliya/Documents/FullStackDev/Test/cv"};
				const buildManifest = {"client":{"/Users/souliya/Documents/FullStackDev/Test/cv/src/styles/app.css":{"file":"assets/app-CV-tluWX.css","src":"/Users/souliya/Documents/FullStackDev/Test/cv/src/styles/app.css"},"_client-6zZzFQoE.js":{"file":"assets/client-6zZzFQoE.js","name":"client","dynamicImports":["src/routes/index.tsx?tsr-split=component"],"assets":["assets/app-CV-tluWX.css"]},"src/routes/index.tsx?tsr-split=component":{"file":"assets/index-Dxb1dFVe.js","name":"index","src":"src/routes/index.tsx?tsr-split=component","isDynamicEntry":true,"imports":["_client-6zZzFQoE.js"]},"virtual:$vinxi/handler/client":{"file":"assets/client-CEygadpM.js","name":"client","src":"virtual:$vinxi/handler/client","isEntry":true,"imports":["_client-6zZzFQoE.js"]}},"ssr":{"/Users/souliya/Documents/FullStackDev/Test/cv/src/styles/app.css":{"file":"assets/app-CV-tluWX.css","src":"/Users/souliya/Documents/FullStackDev/Test/cv/src/styles/app.css"},"src/routes/index.tsx?tsr-split=component":{"file":"assets/index-DoY0beME.js","name":"index","src":"src/routes/index.tsx?tsr-split=component","isDynamicEntry":true},"virtual:$vinxi/handler/ssr":{"file":"ssr.js","name":"ssr","src":"virtual:$vinxi/handler/ssr","isEntry":true,"dynamicImports":["src/routes/index.tsx?tsr-split=component"],"assets":["assets/app-CV-tluWX.css"]}},"server":{"virtual:$vinxi/handler/server":{"file":"server.js","name":"server","src":"virtual:$vinxi/handler/server","isEntry":true}},"api":{"virtual:$vinxi/handler/api":{"file":"api.js","name":"api","src":"virtual:$vinxi/handler/api","isEntry":true}}};
...
const m = [{ path: "/__root", filePath: "/Users/souliya/Documents/FullStackDev/Test/cv/src/routes/__root.tsx" }, { path: "/", filePath: "/Users/souliya/Documents/FullStackDev/Test/cv/src/routes/index.tsx" }], P$1 = ["GET", "POST", "PUT", "PATCH", "DELETE", "OPTIONS", "HEAD"];
function R(o) {
  return eventHandler$1(async (n) => {
    const s = toWebRequest$1(n);
...
const S = async ({ request: o }) => {
  ...
  if (!P$1.includes(o.method)) return new Response("Method not allowed", { status: 405 });
  const n = g$1(f), s = new URL(o.url, "http://localhost:3000"), l = w(s, n);
...
function N(...e) {
  return e.reduce((t, r) => {
    const n = je(r);
    for (const [o, s] of n.entries()) o === "set-cookie" ? splitSetCookieString(s).forEach((d) => t.append("set-cookie", d)) : t.set(o, s);
    return t;
  }, new Headers());
}
const _ = { stringify: (e) => JSON.stringify(e, function(r, n) {
  const o = this[r], s = C.find((i) => i.stringifyCondition(o));
  return s ? s.stringify(o) : n;
}), parse: (e) => JSON.parse(e, function(r, n) {
  const o = this[r];
  if (isPlainObject$1(o)) {
    const s = C.find((i) => i.parseCondition(o));
    if (s) return s.parse(o);
  }
  return n;
}), encode: (e) => {
  if (Array.isArray(e)) return e.map((r) => _.encode(r));
  if (isPlainObject$1(e)) return Object.fromEntries(Object.entries(e).map(([r, n]) => [r, _.encode(n)]));
  const t = C.find((r) => r.stringifyCondition(e));
  return t ? t.stringify(e) : e;
}, decode: (e) => {
  if (isPlainObject$1(e)) {
    const t = C.find((r) => r.parseCondition(e));
    if (t) return t.parse(e);
  }
  return Array.isArray(e) ? e.map((t) => _.decode(t)) : isPlainObject$1(e) ? Object.fromEntries(Object.entries(e).map(([t, r]) => [t, _.decode(r)])) : e;
} }, g = (e, t, r, n) => ({ key: e, stringifyCondition: t, stringify: (o) => ({ [`$${e}`]: r(o) }), parseCondition: (o) => Object.hasOwn(o, `$${e}`), parse: (o) => n(o[`$${e}`]) }), C = [g("undefined", (e) => e === void 0, () => 0, () => {
...
function He(e, t) {
  e.ssr = { manifest: t, serializer: _ }, e.serverSsr = { injectedHtml: [], streamedKeys: /* @__PURE__ */ new Set(), injectHtml: (r) => {
    ...
    warning(!e.serverSsr.streamedKeys.has(r), "Key has already been streamed: " + r), e.serverSsr.streamedKeys.add(r), e.serverSsr.injectScript(() => `__TSR_SSR__.streamedValues['${r}'] = { value: ${y(e.ssr.serializer.stringify(n), { isScriptContext: true, wrap: true, json: true })}}`);
  }, onMatchSettled: Ae }, e.serverSsr.injectScript(() => ke, { logScript: false });
}
function Pe(e) {
  var t, r;
  const n = { manifest: e.ssr.manifest, dehydratedData: (r = (t = e.options).dehydrate) == null ? void 0 : r.call(t) };
  e.serverSsr.injectScript(() => `__TSR_SSR__.dehydrated = ${y(e.ssr.serializer.stringify(n), { isScriptContext: true, wrap: true, json: true })}`);
}
function De(e, t) {
  const r = [];
  return { replaced: P(e, (o, s) => {
    if (o instanceof ReadableStream) {
      const [i, d] = o.tee(), a = { type: "stream", path: s, id: r.length, matchIndex: t.match.index, stream: d };
      return r.push(a), i;
    } else if (o instanceof Promise) {
      const i = defer$1(o), d = { type: "promise", path: s, id: r.length, matchIndex: t.match.index, promise: i };
      r.push(d);
    }
    return o;
  }), extracted: r };
...
function Ae(e) {
  ...
  if (r.loaderData !== void 0) {
    const a = De(r.loaderData, { match: r });
    r.loaderData = a.replaced, n = a.extracted, o = n.reduce((f, m) => H(f, ["temp", ...m.path], void 0), { temp: a.replaced }).temp;
  }
  const s = `__TSR_SSR__.initMatch(${y({ id: r.id, __beforeLoadContext: t.ssr.serializer.stringify(r.__beforeLoadContext), loaderData: t.ssr.serializer.stringify(o), error: t.ssr.serializer.stringify(r.error), extracted: n == null ? void 0 : n.map((a) => pick(a, ["type", "path"])), updatedAt: r.updatedAt, status: r.status }, { isScriptContext: true, wrap: true, json: true })})`;
  t.serverSsr.injectScript(() => s), n && n.forEach((a) => a.type === "promise" ? i(a) : d(a));
  function i(a) {
    t.serverSsr.injectScript(async () => (await a.promise, `__TSR_SSR__.resolvePromise(${y({ matchId: r.id, id: a.id, promiseState: a.promise[TSR_DEFERRED_PROMISE] }, { isScriptContext: true, wrap: true, json: true })})`));
  }
  function d(a) {
    t.serverSsr.injectHtml(async () => {
      try {
        ...
        for (; !(m = await f.read()).done; ) if (m.value) {
          const T = `__TSR_SSR__.injectChunk(${y({ matchId: r.id, id: a.id, chunk: m.value }, { isScriptContext: true, wrap: true, json: true })})`;
          t.serverSsr.injectScript(() => T);
        }
        t.serverSsr.injectScript(() => `__TSR_SSR__.closeStream(${y({ matchId: r.id, id: a.id }, { isScriptContext: true, wrap: true, json: true })})`);
      } catch (f) {
...
function H(e, t, r) {
  ...
  const [n, ...o] = t;
  return Array.isArray(e) ? e.map((s, i) => i === Number(n) ? H(s, o, r) : s) : isPlainObject$1(e) ? { ...e, [n]: H(e[n], o, r) } : e;
}
function P(e, t, r = []) {
  if (isPlainArray(e)) return e.map((o, s) => P(o, t, [...r, `${s}`]));
  if (isPlainObject$1(e)) {
    const o = {};
    for (const s in e) o[s] = P(e[s], t, [...r, s]);
    return o;
  }
  const n = t(e, r);
  return n !== e ? n : e;
}
function Ie({ createRouter: e, getRouterManifest: t }) {
  return (r) => eventHandler(async (n) => {
    const o = toWebRequest(n), s = new URL(o.url), i = s.href.replace(s.origin, ""), d = createMemoryHistory({ initialEntries: [i] }), a = e();
    He(a, t == null ? void 0 : t()), a.update({ history: d }), await a.load(), Pe(a);
    const f = $e({ event: n, router: a });
    return await r({ request: o, router: a, responseHeaders: f });
  });
}
function $e(e) {
  let t = N(getResponseHeaders(e.event), e.event.___ssrRpcResponseHeaders, { "Content-Type": "text/html; charset=UTF-8" }, ...e.router.state.matches.map((n) => n.headers));
  const { redirect: r } = e.router.state;
  return r && (t = N(t, r.headers, { Location: r.href })), t;
}
function ze(e, t) {
  return B(e, t);
}
function Me(e, t) {
  return Readable$1.fromWeb(B(e, Readable$1.toWeb(t)));
}
const Oe = /(<body)/, Ne = /(<\/body>)/, Fe = /(<\/html>)/, Be = /(<head.*?>)/, Le = /(<\/[a-zA-Z][\w:.-]*?>)/g, We = new TextDecoder();
function qe() {
  let e;
...
function B(e, t) {
  const r = qe();
  let n = true, o = "", s = "", i = false, d = false, a = "", f = "";
  function m() {
    const l = o;
    return o = "", l;
  }
  function T(l) {
    return l instanceof Uint8Array ? We.decode(l) : String(l);
  }
  ...
  return R.then(() => {
    ...
    const x = T(l.value);
    let u = a + x;
    const E = u.match(Ne), A = u.match(Fe);
    if (i || u.match(Oe) && (i = true), !d) {
      const p = u.match(Be);
      if (p) {
        d = true;
        const I = p.index, $ = p[0], K = u.slice(I + $.length);
        r.write(u.slice(0, I) + $ + m()), u = K;
      }
    }
    if (!i) {
      r.write(u), a = "";
    ...
    if (E && A && E.index < A.index) {
      const p = E.index;
      s = u.slice(p), r.write(u.slice(0, p) + m()), a = "";
      return;
    }
    let j, b = 0;
    for (; (j = Le.exec(u)) !== null; ) b = j.index + j[0].length;
    if (b > 0) {
      const p = u.slice(0, b) + m() + f;
      r.write(p), a = u.slice(b);
    } else a = u, f += m();
  }, onEnd: () => {
    n = false, w === 0 && R.resolve();
  }, onError: (l) => {
    console.error("Error reading appStream:", l), r.destroy(l);
  } }), r.stream;
}
const Ve = async ({ request: e, router: t, responseHeaders: r }) => {
  if (typeof v$1.renderToReadableStream == "function") {
    const n = await v$1.renderToReadableStream(jsx(O, { router: t }), { signal: e.signal });
  ...
  if (typeof v$1.renderToPipeableStream == "function") {
    ...
    try {
      const s = v$1.renderToPipeableStream(jsx(O, { router: t }), { ...isbot(e.headers.get("User-Agent")) ? { onAllReady() {
        s.pipe(n);
      } } : { onShellReady() {
        s.pipe(n);
      } }, onError: (i, d) => {
...
}, Qe = () => ({ routes: { __root__: { filePath: "__root.tsx", children: ["/"], preloads: ["/_build/assets/client-CEygadpM.js", "/_build/assets/client-6zZzFQoE.js"] }, "/": { filePath: "index.tsx" } } });
function Ke(e) {
  return globalThis.MANIFEST[e];
}
function Ge() {
  var _a;
  const e = Qe(), t = e.routes.__root__ = e.routes.__root__ || {};
  t.assets = t.assets || [];
  let r = "";
  const n = Ke("client"), o = (_a = n.inputs[n.handler]) == null ? void 0 : _a.output.path;
  return o || invariant$1(o, "Could not find client entry in vinxi manifest"), t.assets.push({ tag: "script", attrs: { type: "module", suppressHydrationWarning: true, async: true }, children: `${r}import("${o}")` }), e;
}
function Je() {
  const e = Ge();
...
const Ze = { theme: "system", setTheme: () => null }, Xe = createContext$1(Ze);
function Ye({ children: e, defaultTheme: t = "system", storageKey: r = "vite-ui-theme", ...n }) {
  ...
  const i = { theme: o, setTheme: (d) => {
    s(d);
  } };
  return jsx(Xe.Provider, { ...n, value: i, children: e });
}
const et = "/_build/assets/app-CV-tluWX.css", tt = ({ title: e, description: t, keywords: r, image: n }) => [{ title: e }, { name: "description", content: t }, { name: "keywords", content: r }, { name: "twitter:title", content: e }, { name: "twitter:description", content: t }, { name: "twitter:creator", content: "@tannerlinsley" }, { name: "twitter:site", content: "@tannerlinsley" }, { name: "og:type", content: "website" }, { name: "og:title", content: e }, { name: "og:description", content: t }, ...n ? [{ name: "twitter:image", content: n }, { name: "twitter:card", content: "summary_large_image" }, { name: "og:image", content: n }] : []], q = createRootRouteWithContext()({ head: () => ({ meta: [{ charSet: "utf-8" }, { name: "viewport", content: "width=device-width, initial-scale=1" }, ...tt({ title: "TanStack Start | Type-Safe, Client-First, Full-Stack React Framework", description: "TanStack Start is a type-safe, client-first, full-stack React framework. " })], links: [{ rel: "stylesheet", href: et }, { rel: "apple-touch-icon", sizes: "180x180", href: "/apple-touch-icon.png" }, { rel: "icon", type: "image/png", sizes: "32x32", href: "/favicon-32x32.png" }, { rel: "icon", type: "image/png", sizes: "16x16", href: "/favicon-16x16.png" }, { rel: "manifest", href: "/site.webmanifest", color: "#fffff" }, { rel: "icon", href: "/favicon.ico" }] }), errorComponent: (e) => jsx(U, { children: jsx(L, { ...e }) }), notFoundComponent: () => jsx(W, {}), component: rt });
function rt() {
  return jsx(U, { children: jsx(Outlet, {}) });
}
function U({ children: e }) {
  const t = new QueryClient();
  return jsxs("html", { children: [jsx("head", { children: jsx(HeadContent, {}) }), jsxs("body", { children: [jsxs(QueryClientProvider, { client: t, children: [jsx(Ye, { defaultTheme: "light", storageKey: "portfolio-theme", children: e }), jsx(TanStackRouterDevtools, { position: "bottom-right" }), jsx(ReactQueryDevtools, { buttonPosition: "bottom-left" })] }), jsx(Scripts, {})] })] });
}
const nt = () => import('../build/index-DoY0beME.mjs'), V = createFileRoute("/")({ component: lazyRouteComponent(nt, "component", () => V.ssr) }), ot = V.update({ id: "/", path: "/", getParentRoute: () => q }), st = { IndexRoute: ot }, at = q._addFileChildren(st)._addFileTypes();
function it() {
  const e = new QueryClient();
  return routerWithQueryClient(createRouter$2({ routeTree: at, context: { queryClient: e }, defaultPreload: "intent", defaultErrorComponent: L, defaultNotFoundComponent: () => jsx(W, {}) }), e);
}
const bt = Ie({ createRouter: it, getRouterManifest: Je })(Ve);
...
const handlers = [
  ...
  { route: '/', handler: bt, lazy: false, middleware: true, method: undefined }
];
...
export { handler as h, node$1 as n };
